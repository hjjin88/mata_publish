    ...
    return (
        ...
        <div className="Pop">
            ...
            <div className="Pop-ty02">
                ...
                {/* <div className="Pop-img">
                    <img className="Pop-img-twinkle" src="/resources/img/twinkle_mo.svg" alt="반짝이 이미지" />
                    <img className="Pop-img-inner" src="/resources/img/giftbox_mo.svg" alt="선물 상자 이미지" />
                </div> 
                <div className="Pop-txt">랜덤 박스에 당첨 되셨습니다!<br/> 메세지함 에서 랜덤박스를 확인 해보세요!</div>*/}
                {/* 3. 더본코리아 상품권 */}
                {/* <div className="Pop-img">
                    <img className="Pop-img-twinkle" src="/resources/img/twinkle_mo.svg" alt="반짝이 이미지" />
                    <img className="Pop-img-inner" src="/resources/img/td_giftcard_mo.svg" alt="더본 코리아 상품권 이미지" />
