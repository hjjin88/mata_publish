          ...
          <div className="Tutorial-con txt-40Wt">
            ...
            >
              <SwiperSlide>
                ...
                <div className="check">
                  <label for="checkbox">오늘 하루 보지 않기</label><input type="checkbox" name="checkbox" id="checkbox"/>
                </div>
              </SwiperSlide>
              <SwiperSlide>
              <div className="check plus">
                  <label for="checkbox">공지사항 추가</label><input type="checkbox" name="checkbox" id="checkbox"/>
                </div>
                <div className="img_box">
                  <div className="img_box_inner">
                    <button type="button" className="sec-btn">이미지 등록</button>
                  </div>
                </div>
